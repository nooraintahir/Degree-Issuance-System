<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Allactivity.aspx.cs" Inherits="Activity" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;<br />
        <asp:Button ID="Button2" runat="server" style="margin-left: 561px" Text="Refresh" Height="48px" OnClick="Button2_Click" Width="281px" />
        <br />
        <br /><br />
        <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" style="margin-left: 444px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
